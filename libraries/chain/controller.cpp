...
*/
   ...
   void startup(std::function<void()> shutdown, std::function<bool()> check_shutdown, const snapshot_reader_ptr& snapshot) {
      ...
      kv_db.get_kv_undo_stack()->revision(db.revision());
      EOS_ASSERT( db.revision() == kv_db.get_kv_undo_stack()->revision(), database_revision_mismatch_exception,
                 "chainbase is at revision ${a}, but chain-kv is at revision ${b}", ("a", db.revision())("b", kv_db.get_kv_undo_stack()->revision()) );
